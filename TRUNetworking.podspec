...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangyunfeng/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangyunfeng' => '1906374092.qq.com' }
  s.source           = { :git => 'https://github.com/zhangyunfeng/TRUNetworking.git', :tag => s.version.to_s }
